...
public final class SampleFilters {
    ...
    public static BFilter getStarLitFilter() {
        Point[] rgbKnots;
        ...
        filter.addSubFilter(new BToneCurveSubFilter(rgbKnots, null, null, null));
        return filter;
    }

    public static BFilter getBlueMessFilter() {
        Point[] redKnots;
        ...
        BFilter filter = new BFilter();
        filter.addSubFilter(new BToneCurveSubFilter(null, redKnots, null, null));
        filter.addSubFilter(new BBrightnessSubFilter(30));
        filter.addSubFilter(new BContrastSubFilter(1f));
        return filter;
    }

    public static BFilter getAweStruckVibeFilter() {
        Point[] rgbKnots;
        Point[] redKnots;
        Point[] greenKnots;
        Point[] blueKnots;
        ...
        BFilter filter = new BFilter();
        filter.addSubFilter(new BToneCurveSubFilter(rgbKnots, redKnots, greenKnots, blueKnots));
        return filter;
    }

    public static BFilter getLimeStutterFilter() {
        Point[] blueKnots;
        ...
        BFilter filter = new BFilter();
        filter.addSubFilter(new BToneCurveSubFilter(null, null, null, blueKnots));
        return filter;
    }

    public static BFilter getNightWhisperFilter() {
        Point[] rgbKnots;
        Point[] redKnots;
        Point[] greenKnots;
        Point[] blueKnots;
